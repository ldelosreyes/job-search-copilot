...
import { fitScoreAllRoute } from "./routes/fit-score-all.js";
...
const app = new Hono()
  ...
  .use("/fit-score-all/*", requireApiToken)
  .use("/fit-score-all/*", requireAuth)
  .route("/fit-score-all", fitScoreAllRoute);
